.text
form_string: .string "%d %d %d %d %d %d %d %d"
...
pushq %rbx
subq %rbp, %rbx
cmpq $48, %rbx ##jump over the return address
jne no
popq %rbx
popq %rbx
...
popq %rsi
popq %rdi
addq $8, %rbx ##jump to the next argument in the stack
jmp after_cont
...
syscall
printf(adadada %d afadaa %s, 23, "arsddsa");